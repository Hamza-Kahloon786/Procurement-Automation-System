...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
              className={`md:hidden p-2 transition-colors duration-300 relative z-[60] ${
                isScrolled || isMobileMenuOpen ? 'text-gray-900' : 'text-white'
              }`}
            >
              {isMobileMenuOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
      ...
      {/* Mobile Menu Panel - dropdown below header */}
      {isMobileMenuOpen && (
        <div className="fixed top-0 left-0 right-0 z-[52] md:hidden pt-[56px]">
          <nav className="bg-white shadow-2xl mx-0 px-6 py-4 flex flex-col gap-1 border-t border-gray-100">
            <a
              href="#features"
              className="text-gray-700 py-3 text-base font-medium hover:text-primary-600 transition-colors border-b border-gray-100"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Features
            </a>
            ...
            <Link
              to="/register"
              className="mt-3 px-6 py-3 bg-primary-600 text-white rounded-xl text-center font-semibold hover:bg-primary-700 transition-colors"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Get Started
            </Link>
